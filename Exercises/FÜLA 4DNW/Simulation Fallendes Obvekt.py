...
final_amount = (initial_principal_balance
                * (1 + ((interest_rate / 100) / number_of_times_interest_is_applied))
                ** (number_of_times_interest_is_applied * number_of_time_periods_elapsed))
print(final_amount)
